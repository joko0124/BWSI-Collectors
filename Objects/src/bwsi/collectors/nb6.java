...
public class nb6 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "bwsi.collectors.nb6");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", bwsi.collectors.nb6.class).invoke(this, new Object[] {null});
        else
...
public bwsi.collectors.nb6  _addbuttonaction(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _bmp,Object _title,Object _service,String _action) throws Exception{
Object _ac = null;
...
if (true) return (bwsi.collectors.nb6)(this);};
...
public bwsi.collectors.nb6  _autocancel(boolean _cancel) throws Exception{
...
public bwsi.collectors.nb6  _badgeicontype(String _icontype) throws Exception{
...
public bwsi.collectors.nb6  _bigpicturestyle(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _largeiconbmp,anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _picture,Object _contenttitle,Object _summarytext) throws Exception{
...
public bwsi.collectors.nb6  _bigtextstyle(Object _contenttitle,Object _summarytext,Object _text) throws Exception{
...
public bwsi.collectors.nb6  _color(int _clr) throws Exception{
...
public bwsi.collectors.nb6  _customsound(Object _fileprovideruri) throws Exception{
...
public bwsi.collectors.nb6  _deleteaction(Object _service,String _action) throws Exception{
...
public bwsi.collectors.nb6  _initialize(anywheresoftware.b4a.BA _ba,String _channelid,Object _channelname,String _importancelevel) throws Exception{
innerInitialize(_ba);
...
public bwsi.collectors.nb6  _largeicon(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _icon) throws Exception{
...
public bwsi.collectors.nb6  _number(int _num) throws Exception{
...
public bwsi.collectors.nb6  _oldnotificationicon(String _resourcename) throws Exception{
...
public bwsi.collectors.nb6  _onlyalertonce(boolean _once) throws Exception{
...
public bwsi.collectors.nb6  _progress(int _value,int _maxvalue,boolean _indeterminate) throws Exception{
...
public bwsi.collectors.nb6  _setdefaults(boolean _sound,boolean _light,boolean _vibrate) throws Exception{
...
public bwsi.collectors.nb6  _showwhen(long _time) throws Exception{
...
public bwsi.collectors.nb6  _smallicon(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper _icon) throws Exception{
...
public bwsi.collectors.nb6  _subtext(Object _text) throws Exception{
...
public bwsi.collectors.nb6  _visibility(String _value) throws Exception{
anywheresoftware.b4a.objects.collections.Map _m = null;
int _i = 0;
